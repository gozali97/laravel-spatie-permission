<x-app-layout>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form id="editForm{{ $d->id }}"
                                                        action="{{ route('navigasi.update', $d->id) }}"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group mt-2">
                                                                <input id="name" name="name" type="text"
                                                                    placeholder="Nama menu" class="form-control"
                                                                    value="{{ $d->name }}">
                                                            </div>
                                                            <label for="icon">Icon menu: </label>
                                                            <div class="form-group mt-2">
                                                                <input id="icon" name="icon" type="text"
                                                                    placeholder="icon menu" class="form-control"
                                                                    value="{{ $d->icon }}">
                                                            </div>
                                                            <label for="sort">Sort: </label>
                                                            <div class="form-group mt-2">
                                                                <input id="sort" name="sort" type="text"
                                                                    placeholder="sort menu" class="form-control"
                                                                    value="{{ $d->sort }}">
                                                            </div>
                                                            <label for="url">Link menu: </label>
                                                            <div class="form-group mt-2">
                                                                <input id="url" name="url" type="text"
                                                                    placeholder="url menu" class="form-control"
                                                                    value="{{ $d->url }}">
                                                            </div>
                                                            <label for="nama">Main Menu: </label>
                                                            <fieldset class="form-group mt-1">
                                                                <select name="main_menu" class="form-select"
                                                                    id="basicSelect">
    ...
    <!--Insert Modal -->
    <div class="modal fade text-left" id="insertModal" tabindex="-1" aria-labelledby="insertModal"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('navigasi.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <label for="name">Nama menu: </label>
                        <div class="form-group mt-2">
                        ...
                        <label for="icon">Icon menu: </label>
                        <div class="form-group mt-2">
                            <input id="icon" name="icon" type="text" placeholder="icon menu"
                                class="form-control" value="{{ old('icon') }}">
                        </div>
                        <label for="sort">Sort: </label>
                        <div class="form-group mt-2">
                            <input id="sort" name="sort" type="text" placeholder="sort menu"
                                class="form-control" value="{{ old('sort') }}">
                        </div>
                        <label for="url">Link menu: </label>
                        <div class="form-group mt-2">
                            <input id="url" name="url" type="text" placeholder="url menu"
                                class="form-control" value="{{ old('url') }}">
                        </div>
                        <label for="nama">Main Menu: </label>
                        <fieldset class="form-group mt-1">
                            <select name="main_menu" class="form-select" id="basicSelect">
                                <option value="">-- Pilih --</option>
                                @foreach ($data as $nav)
                                    <option value="{{ $nav->id }}"
                                        {{ $nav->id == old('main_menu') ? 'selected' : '' }}>
                                        {{ $nav->name }}</option>
                                @endforeach
                            </select>
                        </fieldset>
